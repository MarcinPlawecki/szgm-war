...
public class DokWN extends BaseModel implements Serializable {
	...
	public Set<DokWP> getPozycje() {
		return pozycje;
	}

	public void setPozycje(Set<DokWP> pozycje) {
